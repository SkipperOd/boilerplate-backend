...
export const MetaData = buildSchema({
    resolvers: [UserRolesPermissionsInputMutationResolver,RegisterMutationResolver, PermissionMutationResolver, RoleMutationResolver, UserRolesMutationResolver,
        UserQueryResolver, PermissionQueryResolver, RoleQueryResolver]
});
